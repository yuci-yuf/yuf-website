        ...
        <div className="flex w-full flex-col items-center justify-center gap-4 px-2 py-4 text-center sm:gap-5 sm:py-5">
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center px-5 py-3 sm:px-7 sm:py-4">
              ...
              <span className="font-extrabold text-2xl tracking-tight text-white sm:text-3xl lg:text-4xl">10</span>
            </div>
            ...
            {/* Right Stub: OCT 07 */}
            <div className="flex flex-col items-center justify-center px-5 py-3 sm:px-7 sm:py-4">
              <span className="font-extrabold text-[11px] uppercase tracking-widest text-white/80 sm:text-xs">OCT</span>
